...
function generateInitialResponse(topic, role) {
    switch (role) {
        case "leader":
...
function generateFollowUpResponse(topic, previousResponses, role, traits) {
...
function calculateResponseTiming(speakingFrequency) {
